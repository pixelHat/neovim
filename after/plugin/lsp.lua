...
function basic_maps()
  ...
  vim.api.nvim_set_keymap('n', '[e', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', {noremap = true})
  vim.api.nvim_set_keymap('n', ']e', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', {noremap = true})
end
